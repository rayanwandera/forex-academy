    ...
    <div>
      <div className="card" style={{ marginBottom: 20, padding: 0, overflow: 'hidden' }}>
        <div style={{ padding: '1.5rem 1.5rem 0' }}>
          <h3 style={{ fontSize: '1.2rem' }}>Forex Trading Basics</h3>
          <p>From zero to your first MT5 trade — full lesson content plus a graded quiz game.</p>
          <a href="/forex-basics-course.html" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', marginBottom: '1rem' }}>
            Open full screen ↗
          </a>
        </div>
        <iframe
          src="/forex-basics-course.html"
...
function GamesSection() {
  return (
    <div className="card" style={{ marginTop: 32, padding: 0, overflow: 'hidden' }}>
      <div style={{ padding: '1.5rem 1.5rem 0' }}>
        <span className="badge" style={{ marginBottom: 10 }}>🧠 BRAIN BREAK</span>
        <h3 style={{ fontSize: '1.2rem' }}>Sharpen Your Mind</h3>
        <p>
          Trading rewards clear, calculative thinking. Take a few minutes between lessons to play
          chess against the computer — good practice for reading a few moves ahead, weighing
          trade-offs, and staying patient under pressure.
        </p>
        <a href="/games/chess.html" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', marginBottom: '1rem' }}>
          Open full screen ↗
        </a>
      </div>
      <iframe
